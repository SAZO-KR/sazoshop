...
export const dependencyData = new PrdInfoBuilder().options([
  new PrdOptionBuilder('opt1')
    ...
    .hasDependency(true),
  new PrdOptionBuilder('opt2')
    .attributes([
      new PrdAttrBuilder('11').name('opt2-attr1').dependency([['1'], ['2']]),
      ...
      new PrdAttrBuilder('16').name('opt2-attr6').dependency([['5'], ['3']]),
    ])
    .hasDependency(true),
  new PrdOptionBuilder('opt3')
    .attributes([
      new PrdAttrBuilder('21').name('opt3-attr1').dependency([['1', '11']]),
      new PrdAttrBuilder('22').name('opt3-attr2').dependency([
        ['2', '12'],
        ['2', '12'],
      ]),
      new PrdAttrBuilder('23').name('opt3-attr3').dependency([['3', '14']]),
      new PrdAttrBuilder('24').name('opt3-attr4').dependency([
        ['3', '16'],
        ['5', '16'],
      ]),
